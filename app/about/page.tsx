...
export const metadata: Metadata = {
  title: 'About | Khlaif Mohamed - Data Engineer & AI Cloud Engineer',
  description: 'Learn about my journey as a Data Engineer and AI Cloud Engineer, building scalable data platforms and AI solutions in the cloud.',
}

const skills = [
  { category: 'Programming Languages', items: ['Python', 'Java', 'JavaScript', 'SQL', 'TypeScript', 'HTML'] },
  { category: 'Backend Development', items: ['Spring Boot', 'FastAPI', 'Node.js', 'REST APIs'] },
  { category: 'Frontend Development', items: ['React', 'Next.js', 'Tailwind CSS'] },
  { category: 'AI/Machine Learning', items: ['TensorFlow', 'Scikit-learn', 'Pandas'] },
  { category: 'Cloud & DevOps', items: ['GCP (BigQuery)', 'AWS (S3, Lambda, ECR)', 'Docker', 'CI/CD', 'Git', 'Linux'] },
  { category: 'Big Data & Distributed Systems', items: ['Kafka', 'Spark', 'Airflow', 'Cassandra', 'HBase', 'Zookeeper'] },
...
const achievements = [
  {
    ...
    description: 'Migrated pipelines to ELT on BigQuery and standardized transformations with dbt at VISEO',
    icon: Code,
    year: '2024',
  },
  {
    title: 'Data Scientist Intern',
    description: 'Built forecasting models and improved data integrity at the Ministry of Transportation and Logistics',
    icon: Brain,
    year: '2023',
  },
  {
    title: 'Top 10% CNC',
    description: 'Ranked in the top 10% at the Concours National Commun (CPGE MP)',
    icon: Award,
    year: '2022',
  },
  {
    title: 'Real-time ETL Project',
    description: 'Achieved 30% faster processing and 25% efficiency gains using Airflow, Kafka, Spark, Cassandra',
    icon: Users,
    year: '2025',
  },
]
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
                  Building Data Platforms & AI in the Cloud
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  I&apos;m a Software Engineering student at INPT focused on data engineering and cloud-based AI systems. 
                  I design reliable ELT pipelines, scalable data models, and ML solutions using tools like BigQuery, dbt, 
                  Kafka, Spark, and Python—deploying on GCP and AWS where it makes sense.
                </p>
