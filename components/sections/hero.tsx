                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <span className="block">Hi, I&apos;m Khlaif Mohamed.</span>
                                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 animate-gradient">
                                    Data engineer and AI cloud engineer
                                </span>
                            </motion.h1>
                            <motion.p
                            ...
                            >
I build scalable data platforms and AI-driven systems on the cloud. Passionate about data engineering, MLOps, and real-time pipelines. </motion.p>
                        </div>
