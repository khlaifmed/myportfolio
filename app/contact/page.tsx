...
const contactMethods = [
  {
    ...
    value: 'khlaif.mohammed99@gmail.com',
    icon: Mail,
    action: 'mailto:khlaif.mohammed99@gmail.com',
    primary: true,
  },
  // {
  //   title: 'Phone',
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Hard validation: no negative answers allowed for banana hat question
    if (formData.bananaHat.toLowerCase() === 'no') {
      alert('No answers are not accepted 🙂')
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <Badge variant="outline" className="mb-4">Data Engineer & AI Cloud Engineer</Badge>
              <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
                From Academia to Application
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                I build scalable data platforms and AI-powered systems in the cloud. Open to internships and freelance projects.
              </p>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                          <label htmlFor="bananaHat" className="block text-sm font-medium mb-2">Did you like my banana hat? <span className="text-red-500">(required)</span></label>
                          <select id="bananaHat" name="bananaHat" value={formData.bananaHat} onChange={handleInputChange} required className="w-full px-3 py-2 border border-input bg-background rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent">
                            <option value="yes">Yes</option>
                            <option value="no">No (not accepted)</option>
                          </select>
                        </div>
                        <div>
                  ...
                  <Card className="overflow-hidden">
                    ...
                    <CardContent className="p-4 space-y-4">
                      ...
                      <div className="flex items-center gap-4 p-3 rounded-lg border bg-card">
                        ...
                        />
                        <div>
                          <h4 className="font-bold">KHLAIF MOHAMED</h4>
                          <p className="text-xs text-muted-foreground">Data Engineer & AI Cloud Engineer</p>
                          <Link href="https://www.linkedin.com/in/mohamed-khlaif-947b65235/" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-primary hover:underline">
                            Connect on LinkedIn
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <Button variant="outline" className="w-full justify-start" asChild>
                          <Link href="https://www.linkedin.com/in/mohamed-khlaif-947b65235/" target="_blank" rel="noopener noreferrer">
                            <Linkedin className="w-4 h-4 mr-2" /> LinkedIn
                          </Link>
                        </Button>
                        <Button variant="outline" className="w-full justify-start" asChild>
                          <Link href="https://github.com/khlaifmed" target="_blank" rel="noopener noreferrer">
